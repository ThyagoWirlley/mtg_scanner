...
def readCard():
    ...
    pathImage = 'src/data/testImages/tiltright.jpg'  # Nome do arquivo da imagem
    cam = cv2.VideoCapture(0)  # Usa a fonte de vídeo 1 = celular; 0 = webcam do computador

    # Ajustado para a altura e largura reais de um card de Pokémon (6,5 cm x 9 cm)
